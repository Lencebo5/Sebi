...
export const StorageKeys = {
  ...
  /** Last resolved premium entitlement — read by the widget queue builder. */
  ...
  /** JS mirror of the queue delivered to the native widget (staleness checks). */
  widgetQueue: 'danas.widget-queue.v1',
} as const;
