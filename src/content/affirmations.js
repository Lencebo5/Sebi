...
exports.getAffirmation = getAffirmation;
exports.getAffirmationsByCategory = getAffirmationsByCategory;
function pack(category, premium, entries) {
...
const byId = new Map(exports.AFFIRMATIONS.map((a) => [a.id, a]));
function getAffirmation(id) {
    return byId.get(id);
}
function getAffirmationsByCategory(category) {
    return exports.AFFIRMATIONS.filter((a) => a.category === category);
}
